...
A group project where we implemented an ETL pipeline to extract job market data from Arbetsförmedlingen’s Jobtech API, transform and model it in Snowflake, and visualize it in an interactive Streamlit dashboard.
